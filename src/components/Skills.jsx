...
const Skills = () => {
  ...
  const skillCategories = [
    ...
    {
      title: "Cloud, Dev Tools & Version Control",
      icon: Cloud,
      items: [
        { name: "AWS Core Services", level: 80 },
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto font-medium">
            Technical skills gained through full-stack development, AWS cloud projects,
  Google Cloud labs, and continuous hands-on learning.
          </p>
        </div>
              ...
              >
                ...
                <CardContent className="p-8 relative z-10">
                  ...
                  <div className="flex items-center mb-6">
                    <div
                      className={`p-4 bg-gradient-to-r ${category.gradient} rounded-2xl mr-4 group-hover:scale-110 transition-transform duration-300`}
                    >
                    ...
                    {category.items.map((skill, skillIndex) => (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span
                            className={`text-sm font-bold px-2 py-1 rounded-full bg-gradient-to-r ${category.gradient} text-white`}
                          >
                            {skill.level}%
                          </span>
                        </div>
        ...
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            {
              number: "18+",
              label: "Google Cloud Skills Boost Badges",
